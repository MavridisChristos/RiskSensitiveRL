...
# Simulation Epochs
train_loops = 20 # hundreds of training epochs
test_loops = 5 # hundreds of testing epochs
nepochs = 100
...
for k in range(train_loops):
    ...
    for i in range(nepochs):
        ...
        for t in range(time_steps):
            ...
            entropy = -np.sum(policy_np * np.log(policy_np))
        ...
        # Update RL model (policy gradient algorithms)
